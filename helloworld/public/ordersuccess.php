...
<body>
    ...
    <div id="wrapper">
        <div class="grid listPage">
            <div class="mainBox">
                <div class="content">
                    <div class="padTop head">
                        <p class="textTitle" style=
                        "float:none;text-align:center;margin-top:-30px;font-size:24px;">
                        Your order was completed. An email has been sent to you
                        with more information.</p>
                    </div><a class=" centeredBlock submit" href="../freshbox">
                    <p class="textTitle" style=
